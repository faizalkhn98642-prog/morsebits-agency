...
const Puzzle = createLucideIcon("puzzle", __iconNode$1);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function Footer() {
  const scrollTo = (id) => {
    var _a2;
    (_a2 = document.getElementById(id.replace("#", ""))) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center justify-center w-8 h-8 rounded-md bg-primary text-primary-foreground font-display font-bold text-sm glow-accent", children: "M" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground tracking-tight", children: "MorseBits" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed max-w-xs mb-6", children: "Building tomorrow's web, today. We engineer secure, scalable, and intelligent applications for the most ambitious teams." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3 mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "contact@morsebits.com" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", "data-ocid": "footer-social", children: SOCIAL_LINKS.map(({ label, href, Icon: Icon2 }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href,
            target: "_blank",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 16, strokeWidth: 1.75 })
          },
          label
        )) })
      ] }),
      FOOTER_LINKS.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-bold text-sm text-foreground uppercase tracking-widest mb-4", children: col.heading }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-col gap-2", children: col.links.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        currentYear,
        " MorseBits Private Limited. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: cn(
        ...
        scrolled ? "bg-card/90 backdrop-blur-md border-b border-border shadow-xs" : "bg-transparent"
      ),
      "data-ocid": "navbar",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-6 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center justify-center w-8 h-8 rounded-md bg-primary text-primary-foreground font-display font-bold text-sm glow-accent", children: "M" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground tracking-tight group-hover:text-primary transition-smooth", children: "MorseBits" })
              ]
            }
          ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "px-6 py-4 flex flex-col gap-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "pt-2 border-t border-border mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  type: "button",
                  variant: "primary",
...
function SectionWrapper({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6", children })
    }
  );
}
function SectionHeading({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("mb-16", centered && "text-center", className), children: [
    eyebrow && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold tracking-widest uppercase text-primary mb-3", children: eyebrow }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-4xl md:text-5xl font-bold text-tight text-foreground mb-4 text-balance", children: title }),
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg max-w-2xl mx-auto text-balance", children: subtitle })
  ] });
}
const services = [
  {
    ...
    description: "High-performance, memory-safe applications built with Rust. From backend services to embedded systems.",
    subServices: [
      "Custom Development",
      "Consulting",
      "Web Design",
  ...
  },
  {
    ...
    description: "Decentralized platform development on Solana, Ethereum, and emerging L2 networks with full DeFi integration.",
    subServices: [
      "Smart Contracts",
      "DeFi Protocols",
      "NFT Ecosystems",
  ...
  },
  {
    ...
    icon: "🧠",
    title: "AI Services",
    description: "Custom machine learning models and algorithm solutions for business intelligence, customer insights, and automation.",
    subServices: [
  ...
  },
  {
    ...
    description: "Strategic digital marketing campaigns designed to boost online sales, grow audiences, and maximize ROI.",
    subServices: [
      "Campaign Strategy",
      "Automation Flows",
      "A/B Testing",
...
const processSteps = [
  {
    ...
    description: "You share your vision, goals, and technical requirements. We listen and ask the right questions.",
    icon: "💬"
  },
  {
    step: 2,
    title: "Specs & Cost Estimates",
    description: "We produce a detailed technical specification and transparent cost breakdown — no surprises.",
    icon: "📋"
  },
  {
    step: 3,
    title: "Prototyping & UX/UI Design",
    description: "Interactive wireframes and high-fidelity designs validated with real user feedback before we write a line of code.",
    icon: "🎨"
  },
  {
    step: 4,
    title: "Frontend & Backend Development",
    description: "Parallel development sprints with weekly demos and continuous integration for rapid iteration.",
    icon: "💻"
  },
  {
    step: 5,
    title: "Testing",
    description: "Rigorous QA: unit tests, integration tests, security audits, and load testing to ensure production readiness.",
    icon: "🧪"
  },
  {
    step: 6,
    title: "Delivery",
    description: "Smooth deployment to your infrastructure with full documentation, knowledge transfer, and go-live support.",
    icon: "🚀"
  },
  {
    step: 7,
    title: "Ongoing Support",
    description: "Post-launch monitoring, performance optimization, and priority support to keep your product thriving.",
    icon: "🛡️"
  }
];
const testimonials = [
  {
    id: "t1",
    quote: "MorseBits delivered our entire blockchain infrastructure in record time. Their Rust expertise is second to none — the system handles 10k TPS without breaking a sweat.",
    author: "Arjun Mehta",
    role: "CTO",
    company: "MimirChain",
    avatar: "AM"
  ...
  {
    id: "t2",
    quote: "We needed a DeFi protocol that was both secure and blazing fast. MorseBits not only nailed the technical execution but also challenged our thinking in the best way possible.",
    author: "Sofia Reyes",
    role: "CEO",
    company: "CryptoWave",
    avatar: "SR"
  ...
  {
    id: "t3",
    quote: "From ideation to launch in 8 weeks — the team's ability to turn complex requirements into elegant solutions is genuinely impressive. Best technical partnership we've had.",
    author: "Daniel Park",
  ...
  {
    id: "t4",
    quote: "Security and compliance in FinTech is non-negotiable. MorseBits understood that from day one. Their Rust backend has been running in production for 18 months with zero incidents.",
    author: "Priya Kapoor",
  ...
  {
    id: "t5",
    quote: "We needed custom AI models to track sustainability metrics at scale. MorseBits built exactly what we needed and provided ongoing support that kept us moving.",
  ...
  {
    id: "t6",
    quote: "The e-commerce platform MorseBits built handles our 200k daily users seamlessly. The attention to performance and UX details set them apart from every other agency we've worked with.",
  ...
  {
    id: "t7",
    quote: "Our email marketing automation went from mediocre to exceptional after MorseBits overhauled the system. Open rates up 67%, conversions up 41%. The data speaks for itself.",
...
const portfolioItems = [
  {
    ...
    description: "High-throughput L1 blockchain written in Rust with custom consensus mechanism achieving 10,000+ TPS.",
    category: "Blockchain",
  ...
  },
  {
    ...
    description: "Full-stack DeFi protocol on Solana with AMM, liquidity pools, and yield farming mechanisms.",
    category: "Web3",
  ...
  },
  {
    ...
    description: "Enterprise ML platform for real-time customer behaviour prediction with 94% accuracy on conversion propensity.",
    category: "AI",
  ...
  },
  {
    ...
    description: "Gas-optimized NFT marketplace on Ethereum supporting ERC-721 and ERC-1155 with cross-chain bridging.",
    category: "Web3",
  ...
  },
  {
    ...
    description: "Custom e-commerce backend in Rust serving 200k daily users with sub-10ms response times globally.",
    category: "Rust",
  ...
  },
  {
    ...
    description: "Automated KYC/AML compliance system with real-time transaction monitoring and regulatory reporting.",
    category: "FinTech",
  ...
  },
  {
    ...
    description: "AI-powered sustainability platform tracking scope 1-3 emissions for enterprise organizations.",
    category: "AI",
  ...
  },
  {
    ...
    description: "On-chain governance framework enabling token-weighted voting with time-locked execution and quorum controls.",
    category: "Blockchain",
...
const blogPosts = [
  {
    id: "b1",
    title: "Why Rust is the Language of Choice for High-Stakes Blockchain Infrastructure",
    excerpt: "Memory safety, zero-cost abstractions, and fearless concurrency — we break down why Rust dominates the blockchain infrastructure stack and what it means for your next project.",
    category: "Rust",
    date: "March 15, 2025",
    readTime: "8 min read"
  },
  {
    id: "b2",
    title: "Building Gas-Efficient DeFi Protocols: Lessons from 10+ Deployments",
    excerpt: "Gas optimization is an art and a science. After deploying over a dozen DeFi protocols, we've distilled the patterns that cut gas costs by 30-60% without compromising security.",
    category: "Web3",
  ...
  },
  {
    ...
    excerpt: "LLMs offer real business value — but only when integrated with discipline. We share our framework for evaluating, integrating, and measuring ROI on AI language model deployments.",
    category: "AI",
...
function BlogSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionWrapper, { sectionId: "blog", alt: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
        eyebrow: "Insights",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: blogPosts.map((post) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "article",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base text-foreground mb-3 tracking-tight leading-snug group-hover:text-primary transition-smooth", children: post.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed mb-5 line-clamp-3", children: post.excerpt }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
...
function ContactSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionWrapper, { sectionId: "contact", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto", children: submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl text-foreground mb-3", children: "Message Sent!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Thanks for reaching out. We'll review your project details and respond within 24 hours." })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "form",
      {
        ...
        children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "rust", children: "Rust Development" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "web3", children: "Web3 & Blockchain" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "ai", children: "AI Services" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "marketing", children: "Email Marketing" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "other", children: "Other / Not Sure" })
                ]
              }
            )
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-muted-foreground", children: "We respond within 24 hours · No spam, ever · contact@morsebits.com" })
        ]
      }
    ) })
  ] });
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "linear-gradient(oklch(var(--primary) / 0.3) 1px, transparent 1px), linear-gradient(90deg, oklch(var(--primary) / 0.3) 1px, transparent 1px)",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse, oklch(var(--primary) / 0.6) 0%, transparent 70%)"
            },
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-7xl mx-auto px-6 py-32 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/40 bg-primary/10 text-primary text-sm font-medium mb-8 animate-fade-in", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-primary animate-glow-pulse" }),
            "Rust · Web3 · AI"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-bold text-5xl md:text-7xl lg:text-8xl text-tight text-foreground mb-6 text-balance animate-slide-up", children: [
            "Engineering",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                ...
                style: {
                  backgroundImage: "linear-gradient(135deg, oklch(var(--primary)), oklch(0.65 0.18 240))"
                },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xl md:text-2xl max-w-3xl mx-auto mb-10 text-balance leading-relaxed animate-fade-in", children: "MorseBits builds secure, scalable, and intelligent applications at the intersection of blockchain and artificial intelligence. We turn complex tech challenges into seamless digital solutions." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: "Estimate Project Cost"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 mt-20 max-w-4xl mx-auto", children: [
            {
              icon: "⚙️",
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl mb-3", children: item.icon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground text-sm uppercase tracking-wider mb-1", children: item.label }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-muted-foreground/50 animate-fade-in", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs tracking-widest uppercase", children: "Scroll" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-px h-8 bg-gradient-to-b from-muted-foreground/50 to-transparent" })
        ] })
      ]
    }
  );
...
function PortfolioSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionWrapper, { sectionId: "portfolio", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
        eyebrow: "Our Work",
      ...
      "div",
      {
        ...
        children: CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: `px-4 py-2 rounded-full text-sm font-medium transition-smooth ${filter === cat ? "bg-primary text-primary-foreground shadow-glow" : "border border-border text-muted-foreground hover:text-foreground hover:border-primary/40 bg-card/40"}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5", children: filtered.map((item) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `h-1 w-full bg-gradient-to-r ${config.bar}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
...
function ProcessSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionWrapper, { sectionId: "process", alt: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
        eyebrow: "How We Work",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-7 gap-6", children: processSteps.map((step, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 w-14 h-14 rounded-full bg-card border-2 border-primary/40 flex items-center justify-center text-xl mb-4 group-hover:border-primary group-hover:shadow-glow transition-smooth", children: step.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-primary/60 mb-1 tracking-widest", children: String(step.step).padStart(2, "0") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm text-foreground mb-2 tracking-tight leading-tight", children: step.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-relaxed", children: step.description })
          ]
        },
        step.step
      )) })
...
function ServicesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionWrapper, { sectionId: "services", alt: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
        eyebrow: "What We Do",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: services.map((service) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground mb-3 tracking-tight", children: service.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed mb-5", children: service.description }),
          service.subServices && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: service.subServices.map((sub) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function StatsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card/50 border-y border-border py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4", children: stats.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "text-center",
      "data-ocid": `stat-${stat.label.replace(/\s+/g, "-").toLowerCase()}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-4xl md:text-5xl text-tight mb-1 text-primary", children: stat.value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-medium", children: stat.label })
      ]
    },
    stat.label
  )) }) }) });
...
function TestimonialsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionWrapper, { sectionId: "testimonials", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: testimonials.map((t, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `bg-card border border-border rounded-xl p-6 hover:border-primary/40 hover:shadow-glow transition-smooth lift-on-hover ${index2 === 0 ? "md:col-span-2 lg:col-span-1" : ""}`,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("blockquote", { className: "text-muted-foreground leading-relaxed text-sm mb-6", children: t.quote }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-primary/20 border border-primary/30 flex items-center justify-center font-display font-bold text-sm text-primary flex-shrink-0", children: t.author.split(" ").map((n) => n[0]).join("").slice(0, 2) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm truncate", children: t.author }),
...
const PILLARS = [
  {
    ...
    description: "Our engineers bring deep, specialist knowledge in Rust, blockchain, and AI — not generalist dabbling. We've shipped production systems across every domain we serve, so you benefit from battle-tested patterns on day one.",
  ...
  },
  {
    ...
    description: "Off-the-shelf tools slow ambitious teams down. We design every architecture from first principles around your specific constraints, scale targets, and business logic — no copy-paste templates.",
  ...
  },
  {
    ...
    description: "We embed as a true technical partner, not a ticket-taking vendor. Transparent timelines, weekly demos, and a shared stake in your success mean you always know where things stand and why.",
    accentClass: "text-emerald-400 bg-emerald-500/10 border-emerald-500/20"
  }
];
function WhyChooseUsSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SectionWrapper, { sectionId: "why-choose-us", alt: true, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: PILLARS.map((pillar) => {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 22, strokeWidth: 1.75 })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-xl text-foreground mb-3 tracking-tight", children: pillar.heading }),
